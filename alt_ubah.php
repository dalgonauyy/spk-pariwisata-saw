                ...
                <section class="wrapper">
                    ...
                    if (isset($_POST['edit'])) {
                        ...
                        if (($nama == "") or ($alamat == "")) {
                            ...
                            $sql = "UPDATE saw_aplikasi SET nama='$nama',alamat='$alamat', kategori='$kategori' 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <select class="form-control" name="kategori" value="<?= $kategori ?>">
                                        <option <?php if ($kategori == 'Pantai') {
                                                    echo 'selected';
                                                } ?>>Pantai</option>
                                        <option <?php if ($kategori == 'Sejarah') {
                                                    echo 'selected';
                                                } ?>>Sejarah</option>
                                        <option <?php if ($kategori == 'Kuliner') {
                                                    echo 'selected';
                                                } ?>>Kuliner</option>
                                        <option <?php if ($kategori == 'Permainan') {
                                                    echo 'selected';
                                                } ?>>Permainan</option>
                                        <option <?php if ($kategori == 'Budaya') {
                                                    echo 'selected';
                                                } ?>>Budaya</option>
